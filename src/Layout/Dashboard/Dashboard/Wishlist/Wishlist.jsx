          ...
          {wishlists.length <= 0 ? (
            <div className="h-[70vh] flex justify-center items-center ">
              <h2 className=" text-base md:text-2xl font-semibold text-black">
                You don't have any{" "}
                <span className=" text-[#FB923C] ">Wishlist yet!!</span>{" "}
              </h2>
            </div>
          ) : (
              ...
              {wishlists?.map((wish) => (
                ...
                >
                  <CardActionArea>
                    ...
                    <CardContent>
                      ...
                      <p className="text-[#F2561B] font-semibold my-1 text-[16px]">
                        {" "}
                        $ {wish?.minimumPrice} -$ {wish?.maximumPrice}{" "}
                      </p>
                  ...
                  <div className="flex justify-between  items-center gap-3 w-full ">
                    <button
                      onClick={() => handleRemove(wish)}
                      className="btn  w-[35%] text-white btn-error"
                    >
                      Remove
                    </button>
                    <button className="btn   mr-1 duration-300  flex gap-1 hover:bg-[#F2561B] hover:text-white justify-end border  text-[#F2561B] border-[#F2561B]">
                      {" "}
                      <Link to={`/buyNow/${wish?._id}`}>
                        Make an Offer
                      </Link>{" "}
                      <FaArrowRight />
                    </button>
