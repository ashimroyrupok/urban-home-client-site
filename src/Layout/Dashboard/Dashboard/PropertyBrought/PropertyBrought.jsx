          ...
          {boughtProperties.length >= 0 ? (
            <div className="h-[70vh] flex justify-center items-center ">
              <h2 className=" text-base md:text-2xl font-semibold text-black">
                You don't have any{" "}
                <span className=" text-[#FB923C] ">property yet!!</span>{" "}
              </h2>
            </div>
          ) : (
                ...
                >
                  <CardActionArea>
                    ...
                    <CardContent>
                      ...
                      <p className="text-[#F2561B] font-semibold my-1 text-[16px]">
                        {" "}
                        Offered Amount: $ {property?.offeredPrice}{" "}
                      </p>
                  ...
                  <div className="flex justify-center mx-auto  items-center gap-3 w-full ">
                    {property?.status ? (
                      <div>
                        {property?.status === "accepted" ? (
                          <button className="btn    mr-1 duration-300 text-center  flex gap-1 hover:bg-[#F2561B] hover:text-white justify-end border  text-[#F2561B] border-[#F2561B]">
                            {" "}
                            <Link to={`/dashboard/payNow/${property?._id}`}>
                              Pay
                            </Link>{" "}
                            <FaArrowRight />
                          </button>
                        ) : (
                          <span className="text-green-600 p-1 btn">
                            {" "}
                      ...
                      <button
                        disabled
                        className="btn   mr-1 duration-300 text-center  flex gap-1 hover:bg-[#F2561B] hover:text-white justify-end border  text-[#F2561B] border-[#F2561B]"
                      >
                        {" "}
                        Pay <FaArrowRight />
                      </button>
