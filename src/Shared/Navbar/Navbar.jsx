    ...
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      ...
      <List>
        <div id="home" className="flex flex-col gap-4">
          ...
          <NavLink to="/allProperties" className="navItem">
            {" "}
            All Properties{" "}
          </NavLink>
        ...
        >
          <Container maxWidth="lg">
            <Toolbar>
              ...
              <div className="flex justify-end w-full p-2 md:w-14">
                {user?.email ? (
                  <div>
                    {" "}
                    <Avatar
                  ...
                  <Link to="/login">
                    {" "}
                    <button className=" border-2 rounded-lg px-3 py-2 hover:text-[#F2561B] border-[#F2561B] mx-8">
                      {" "}
                      Login{" "}
                    </button>{" "}
                  </Link>
