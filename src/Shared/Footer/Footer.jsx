    ...
    return (
        ...
        <footer className="footer text-white footer-center p-10 bg-[#333333]  rounded">
            <nav className=" max-w-4xl mx-auto grid grid-flow-col gap-4">
                ...
                <a className="hover:text-[#F2561B]">Jobs</a>
                <a className="hover:text-[#F2561B]">Press kit</a>
            </nav>
            <nav>
                <div className="flex   max-w-3xl mx-auto my-3 justify-center items-center gap-4">
