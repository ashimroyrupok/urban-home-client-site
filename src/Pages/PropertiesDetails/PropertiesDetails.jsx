        ...
        <div className="mt-20">
                        ...
                        <div className=" lg:w-1/2 mt-2">
                            <div className="flex flex-col justify-between items-center">
                                ...
                                <div className="w-full my-2">
                                    <button onClick={handleWish} className="w-full btn border-2 border-[#F2561B] hover:text-white hover:bg-[#F2561B]">Add to Wishlist <GiSelfLove className="text-red-600 text-2xl"></GiSelfLove> </button>
                                </div>
                            </div>
            ...
            <div>
                ...
                <div className="w-full text-center my-6 items-center">
                    ...
                    <button onClick={handleClickOpen} className="w-1/2 mx-auto border-3 border-[#F2561B] hover:bg-[#F2561B] hover:text-white text-center btn flex items-center justify-center">Add Your Review</button>
                                    ...
                                    <div className="form-control w-full ">
                                        ...
                                        <div className="w-full mx-auto my-5 mt-7">
                                            ...
                                            <div className="w-full">
                                                <textarea onChange={handleTextareaChange} required className=" w-full border-2 border-gray-400" id="" cols="20" rows="4" ></textarea>
                                            </div>
                                            <button onClick={handleReviewSubmit} className="btn text-center">  submit</button>
