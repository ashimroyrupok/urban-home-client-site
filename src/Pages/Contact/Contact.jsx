    ...
    return (
      <div className=" p-5 lg:pt-24">
        <div className="flex items-center  mx-auto w-full lg:w-[60%] col-span-2 justify-center  p-12 ">
          ...
          <div className="mx-auto w-full max-w-[550px] bg-slate-100 shadow-xl rounded-2xl text-black p-8">
            <form
              ref={form}
              onSubmit={sendEmail}
            ...
            >
              <div className="mb-5">
                ...
                >
                  <span>Full Name</span>{" "}
                  <span>
                    <FaAsterisk className="text-[#C9F31D]"></FaAsterisk>
                  </span>
                </label>
                <input
                  type="text"
                  ...
                  className="w-full rounded-md border border-[#e0e0e0]  #2F2F2Fpy-3 px-6 text-base font-medium bg-slate-300 outline-none focus:border-[#6A64F1] focus:shadow-md"
                />
              </div>
              <div className="mb-5">
                <label
              ...
              <div className="mb-5">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-md border border-[#e0e0e0]  #2F2F2Fpy-3 px-6 text-base font-medium bg-slate-300  outline-none focus:border-[#6A64F1] focus:shadow-md"
                  defaultValue={""}
                />
              </div>
              <div>
